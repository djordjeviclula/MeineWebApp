...
fragen_antworten = {
    ...
    "Warum X-CEll?": "X-CELL vereint genau die Aspekte, die mich an IT und Softwareentwicklung faszinieren: Innovative E-Learning-Software, moderne Technologien und praxisnahe digitale Lösungen. Besonders "
                     ...
                     "können – sowohl für die Mitarbeitenden als auch für die Prozesse.Bei X-CELL sehe ich die großartige Möglichkeit, an genau solchen innovativen Lösungen mitzuwirken und gleichzeitig den Bildungsbereich nachhaltig zu verbessern.",
